...
const sidebarItems = [
  ...
  { id: "schulung", name: " IT-Schulungen & Weiterbildungen" },
]
...
const services = [
  ...
  },
  {
    ...
    description: "Kein Wartungsvertrag, keine Mindestlaufzeit: Sie melden sich, wenn Sie Hilfe brauchen – wir lösen das Problem effizient. Sie zahlen nur die effektive Arbeitszeit.",
    icon: Wrench,
    color: "text-red-500",
  },
  {
    id: 6,
    category: "support",
    title: "IT-Beratung für KMUs",
    description: "Wir analysieren Ihre aktuelle IT und zeigen Ihnen Optimierungspotenziale, verständlich erklärt und umsetzbar geplant. Ob Sicherheit, Cloud, Tools oder Schulungsbedarf – wir beraten Sie lösungsorientiert und ohne Fachchinesisch.",
  ...
  },
  {
    id: 8,
    category: "schulung",
    title: "IT-Schulungen für Schulen",
